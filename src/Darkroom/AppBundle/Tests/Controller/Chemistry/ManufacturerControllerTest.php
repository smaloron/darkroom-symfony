...
class ManufacturerControllerTest extends AbstractDoctrineWebTestCase {
    ...
    public function testIndex()
    {
        ...
        $this->assertTrue(  $crawler->filter('td:contains("Ilford")')->count() > 0,
    ...
    public function testCreate(){
        ...
        $this->assertTrue(  Response::HTTP_OK === $this->client->getResponse()->getStatusCode(),
            'The response is not successful');
        $this->assertTrue(  $crawler->filter('td:contains("custom manufacturer")')->count() > 0,
    ...
    public function testUpdate(){
        ...
        $this->assertTrue(  Response::HTTP_OK === $this->client->getResponse()->getStatusCode(),
            'The response is not successful');
        $this->assertTrue(  $crawler->filter('td:contains("updated custom manufacturer")')->count() > 0,
